...
#include <math.h>
#ifndef Second_att_control_codeblock_fly_COMMON_INCLUDES_
# define Second_att_control_codeblock_fly_COMMON_INCLUDES_
#include <Lib/MatlabAttitudeController/rtwtypes.h>
//#include <rtwtypes.h>
#endif                   /* Second_att_control_codeblock_fly_COMMON_INCLUDES_ */

#include <Lib/MatlabAttitudeController/Second_att_control_codeblock_fly_types.h>
...
struct P_Second_att_control_codebloc_T_ {
...
extern P_Second_att_control_codebloc_T Second_att_control_codeblock__P;

/* Block signals (default storage) */
extern B_Second_att_control_codebloc_T Second_att_control_codeblock__B;

/* Block states (default storage) */
extern DW_Second_att_control_codeblo_T Second_att_control_codeblock_DW;

/* External inputs (root inport signals with default storage) */
extern ExtU_Second_att_control_codeb_T Second_att_control_codeblock__U;

/* External outputs (root outports fed by signals with default storage) */
extern ExtY_Second_att_control_codeb_T Second_att_control_codeblock__Y;
...
extern void Second_att_control_codeblock_fly_initialize(void);
extern void Second_att_control_codeblock_fly_step(void);
extern void Second_att_control_codeblock_fly_terminate(void);

/* Exported data declaration */

/* Const memory section */
/* Declaration for custom storage class: Const */
extern const real32_T Max_angle_coef;  /* Referenced by: '<S3>/Gain' */
