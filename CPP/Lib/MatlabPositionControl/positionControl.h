...
class positionControlModelClass {
 ...
 public:
  ...
  typedef struct {
    ...
    real_T SumI2_n;                    // '<S273>/SumI2'
    real_T Kb_e;                       // '<S273>/Kb'
    real_T IntegralGain_b;             // '<S277>/Integral Gain'
    real_T SumI4_c;                    // '<S273>/SumI4'
...
//  '<S177>' : 'positionControl/position control/PID Controller3/Anti-windup/Passthrough'
...
//  '<S273>' : 'positionControl/position control/PID Controller5/Anti-windup/Back Calculation'
